...
# Crer a function to get the api with your own storage backend.
...
contacts1 = api.relations.filter(
    select='ID,Code,Name,Status,IsSales,IsSupplier')
print(contacts1)
for enr in contacts1:
    print(enr['ID'], enr['Code'], enr['Name'], enr['Status'],
          enr['IsSales'], enr['IsSupplier'])
