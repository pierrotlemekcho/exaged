...
function Plannif({ showAdminView }) {
      ...
      <Container>
        <DragDropContext onDragEnd={onDragEnd}>
          ...
          {planning.map((day, dayIndex) => {
            // only admin see unscheduled lines
            if (day.date || showAdminView) {
              return (
                <>
